        ...
        <div className="editWorkspace">
            <form className="editWorkSpace__form" onSubmit={handleSubmit}>
                <div className="editWorkSpace__input-container">
                    <h2 className="editWorkspace_input-title">Workspace Name <Icon svg='pencil' classes="editWorkspace_input-title-icon"></Icon></h2> 
                    <input type="text" name='name' className="editWorkspace__input" onChange={handleChange} value={input.name}/>
                </div>
                <div className="editWorkSpace__input-container">
                    <h2 className="editWorkspace_input-title">Workspace Code <Icon svg='pencil' classes="editWorkspace_input-title-icon"></Icon></h2>
